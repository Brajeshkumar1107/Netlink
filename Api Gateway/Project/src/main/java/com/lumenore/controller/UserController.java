...
public class UserController {
    ...
    public ResponseEntity<?> findUserById(@PathVariable String email) {
        User u = service.getUserByEmail(email);
        return u == null? ResponseEntity.status(HttpStatus.NOT_FOUND).body("User not found"): ResponseEntity.of(Optional.of(u));
    }
